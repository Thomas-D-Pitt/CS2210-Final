...
# Class: c4
	...
	# Method: main
		...
		neg	$11	$11		#unaryneg
		sw	$11	4($sp)		#push value on stack
		# Using default value
		...
		move	$t0	$11		#$offr=>$t0, return address						should not be move			
		...
		L_3:
		move	$t0	$11		#$offr=>$t0, return address										unk
		...
		addi	$sp	$sp	4	#pop st
		lw	$12	4($sp)		#stack top -> $12
		sle	$11	$12	$11	#Less than or equal
		sw	$11	4($sp)		#push result to stack
		lw	$11	4($sp)		#store boolean result in register
		...
		# Function Call
			...
			li	$12	104		#load offset in $12
			sub	$12	$fp	$12	#absoult addr by $fp
			lw	$13	($12)		#load value from ($13) to t12
