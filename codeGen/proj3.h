...
#define TREE_ATTR 3	      /*ptr to DeclList*/                              /* Was: value: point back to the subtree */
...
struct StackElement {
  ...
  bool dummy;             /* dummy element to indicate an undeclared id */
  bool used;              /* this id is used? */
};

extern struct StackElement p3stack[STACK_SIZE]; /* stack array */
