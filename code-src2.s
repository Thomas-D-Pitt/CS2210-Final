...
.text
	...
	addi	$sp	$sp	-4	#push st
	li	$v0	4		#print_str
	la	$a0	S_52		#address of string to print
	...
	beqz	$t2	L_0		#if called from a global obj
...
main:					#method entry
	...
	add	$t1	$t1	24	#init main access link in $t1; .data 24
	...
	addi	$sp	$sp	-4	#increase st
	li	$11	0		#load offset in $11
	add	$11	$11	4	#offr+field relative addr
	add	$11	$11	$gp		#class.---, add to t1 base
	lw	$12	($11)		#load value from ($11) to t12
	sw	$12	0($sp)		#push value on stack
	addi	$sp	$sp	-4	#increase st
